...
import ListOfRestaurantCardswhatsonMind from "./ListOfRestuarantCardswhatsonMind";
import ListOfTopRatedResturantNearYou from "./ListOfTopRatedResturantNearYou";
...
const Body = () => {
  ...
  return (
    <div className="p-4">
      ...
      {/* What's on your mind */}
      <div>
        <ListOfRestaurantCardswhatsonMind
      ...
      <div>
        {finalFilteredList.length > 0 ? (
          <ListOfTopRatedResturantNearYou resData={finalFilteredList} />
        ) : (
