        ...
        <ul className="flex flex-row justify-between">
          <ul className="flex flex-col">
            <li className="w-6 h-6 mb-2">
              <img src={vegetarian_logo} alt="img-logo"/>
            </li>
            <li className="font-bold">{name}</li>
            <li className="font-bold">₹{price/100}</li>
            {ratings?.aggregatedRating?.rating && <ul className="flex flex-row">
              <li className="mt-1 mr-1"><img  className="w-4 " src={greeStar_log} alt="img-logo"/></li>
          ...
          <ul className="flex flex-col p-4 ">
            <li className="w-40  ">
              <img className="rounded-xl w-40 h-30" src={IMG_logo+imageId} alt="img-logo"/>
            </li>
