...
import Deals_forYouRestaurantMenucard from "./Deals_forYouRestaurantMenucard";
  ...
  return (
    <div className="mt-32">
      ...
      <div className="border  border-slate-400 border-b-8 border-l-8 border-r-8  b rounded-3xl  ml-96 mt-6 mr-96 p-4">
        ...
        <h1 className="text-gray-600 border-gray-300 border-t-2 mt-2">
          Order above 149 for discounted delivery fee
        </h1>
      </div>
      <div>
        <Deals_forYouRestaurantMenucard dealData={dealWithData}/>
      </div>
